    ...
    async _initRustBridge() {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.rustBridge.on('close', (code) => {
                // review: removed // review: removed console.log(`[ToolBridge/Rust] Process exited (code ${code})`);
                this.rustBridge = null;
            });
            ...
            this._rustPending.set(id, {
                resolve: () => // review: removed // review: removed console.log('[ToolBridge/Rust] Connected'),
