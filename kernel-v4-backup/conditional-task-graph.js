            ...
            try {
                ...
                return (context) => {
                    try {
                        ...
                        // 安全修复：使用 Node.js 内置 vm 替代已废弃的 vm2（CVE-2023-29017）
                        const sandboxCtx = createContext(Object.assign(Object.create(null), context));
                        return runInContext(`(${expr})`, sandboxCtx, { timeout: 1000, displayErrors: false });
                    } catch (error) {
