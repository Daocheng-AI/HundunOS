...
if not defined HUNDUNOS_ENCRYPTION_KEY (
    for /f "delims=" %%i in ('node -e "// review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed // review: removed console.log(require('crypto').randomBytes(32).toString('hex'))"') do set HUNDUNOS_ENCRYPTION_KEY=%%i
)
```
