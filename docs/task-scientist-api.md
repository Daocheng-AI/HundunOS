...
console.log(analysis.suitable, analysis.confidence);
...
console.log(result.iterations, result.journal);

// 获取统计
const stats = await orch.getStats(taskId);
console.log(stats.total_nodes, stats.max_depth);
