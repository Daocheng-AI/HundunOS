...
本人完全不懂代码，项目开始于内测QClaw时对其的调教，后来让QClaw将配置单独提出来写了初始版，受三省六部项目启发后进行了改造，之后一步步进化迭代，我只提想法和方向，其余全部由AI实现：
- 第一阶段：QClaw开发初始版本 
- 第二阶段：QClaw开发，WorkBuddy审核，之后互相生成代码互相审核，并将项目与GitHub上- 相关项目对比分析进行迭代优化
- 第三阶段：QClaw已无力承担开发任务，主力转为WorkBuddy、CodeArts开发
- 目前项目已经比较庞大，AI开发已经遇到不少问题，调试一次需要消耗大量算力和时间，未来项目走向何方，只能将答案留到未来了
